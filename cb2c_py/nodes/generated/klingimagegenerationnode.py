...
class KlingImageGenerationNodeInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.image_type = Slot[Any](node, "image_type", 'COMBO')
...
class KlingImageGenerationNode(Node[KlingImageGenerationNodeInputs, KlingImageGenerationNodeOutputs]):
    ...
    def __init__(self, prompt: str, negative_prompt: str = None, image_type: Slot[Any] = None, image_fidelity: float = 0.5, human_fidelity: float = 0.45, model_name: Slot[Any] = 'kling-v1', aspect_ratio: Slot[Any] = '16:9', n: int = 1):
