...
class KlingStartEndFrameNode(Node[KlingStartEndFrameNodeInputs, KlingStartEndFrameNodeOutputs]):
    ...
    def __init__(self, start_frame: Slot[Image] = None, end_frame: Slot[Image] = None, prompt: str = None, negative_prompt: str = None, cfg_scale: float = 0.5, aspect_ratio: Slot[Any] = '16:9', mode: str = 'pro mode / 5s duration / kling-v1-5'):
