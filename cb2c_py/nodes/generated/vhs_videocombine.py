...
class VHS_VideoCombine(Node[VHS_VideoCombineInputs, VHS_VideoCombineOutputs]):
    ...
    def __init__(self, images: Slot[Image], format: str, frame_rate: float = 8, loop_count: int = 0, filename_prefix: str = 'AnimateDiff', pingpong: bool = False, save_output: bool = True):
