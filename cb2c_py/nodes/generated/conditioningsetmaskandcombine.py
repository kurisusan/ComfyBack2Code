...
class ConditioningSetMaskAndCombine(Node[ConditioningSetMaskAndCombineInputs, ConditioningSetMaskAndCombineOutputs]):
    ...
    def __init__(self, positive_1: Slot[Conditioning], negative_1: Slot[Conditioning], positive_2: Slot[Conditioning], negative_2: Slot[Conditioning], mask_1: Slot[Any], mask_2: Slot[Any], set_cond_area: str, mask_1_strength: float = 1.0, mask_2_strength: float = 1.0):
