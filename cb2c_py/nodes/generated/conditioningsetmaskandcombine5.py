...
class ConditioningSetMaskAndCombine5(Node):
    """
    ...
    _original_name = "ConditioningSetMaskAndCombine5"

    def __init__(self, positive_1, negative_1, positive_2, negative_2, positive_3, negative_3, positive_4, negative_4, positive_5, negative_5, mask_1, mask_2, mask_3, mask_4, mask_5, set_cond_area, mask_1_strength=1.0, mask_2_strength=1.0, mask_3_strength=1.0, mask_4_strength=1.0, mask_5_strength=1.0):
