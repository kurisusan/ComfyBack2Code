...
class ConditioningSetMaskAndCombine5Inputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.mask_3 = Slot[Any](node, "mask_3", 'MASK')
        self.mask_4 = Slot[Any](node, "mask_4", 'MASK')
        self.mask_5 = Slot[Any](node, "mask_5", 'MASK')
