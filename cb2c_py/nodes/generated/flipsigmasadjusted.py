...
class FlipSigmasAdjusted(Node[FlipSigmasAdjustedInputs, FlipSigmasAdjustedOutputs]):
    ...
    def __init__(self, sigmas: Slot[Any], divide_by_last_sigma: bool = False, divide_by: float = 1, offset_by: int = 1):
