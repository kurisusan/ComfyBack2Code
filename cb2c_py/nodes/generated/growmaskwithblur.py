...
class GrowMaskWithBlur(Node[GrowMaskWithBlurInputs, GrowMaskWithBlurOutputs]):
    ...
    def __init__(self, mask: Slot[Any], expand: int = 0, incremental_expandrate: float = 0.0, tapered_corners: bool = True, flip_input: bool = False, blur_radius: float = 0.0, lerp_alpha: float = 1.0, decay_factor: float = 1.0):
