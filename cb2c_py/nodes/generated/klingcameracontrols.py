...
class KlingCameraControlsInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        self.camera_control_type = Slot[Any](node, "camera_control_type", 'COMBO')
...
class KlingCameraControls(Node[KlingCameraControlsInputs, KlingCameraControlsOutputs]):
    ...
    def __init__(self, camera_control_type: Slot[Any] = None, horizontal_movement: float = 0.0, vertical_movement: float = 0.0, pan: float = 0.5, tilt: float = 0.0, roll: float = 0.0, zoom: float = 0.0):
