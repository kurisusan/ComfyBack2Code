...
class ControlNetApplyAdvanced(Node[ControlNetApplyAdvancedInputs, ControlNetApplyAdvancedOutputs]):
    ...
    def __init__(self, positive: Slot[Conditioning], negative: Slot[Conditioning], control_net: Slot[Any], image: Slot[Image], strength: float = 1.0, start_percent: float = 0.0, end_percent: float = 1.0):
