...
class KlingCameraControlI2VNode(Node[KlingCameraControlI2VNodeInputs, KlingCameraControlI2VNodeOutputs]):
    ...
    def __init__(self, camera_control: Slot[Any], start_frame: Slot[Image] = None, prompt: str = None, negative_prompt: str = None, cfg_scale: float = 0.75, aspect_ratio: Slot[Any] = '16:9'):
