...
class CLIPTextEncodeSDXL(Node[CLIPTextEncodeSDXLInputs, CLIPTextEncodeSDXLOutputs]):
    ...
    def __init__(self, clip: Slot[Clip], text_g: str, text_l: str, width: int = 1024.0, height: int = 1024.0, crop_w: int = 0, crop_h: int = 0, target_width: int = 1024.0, target_height: int = 1024.0):
