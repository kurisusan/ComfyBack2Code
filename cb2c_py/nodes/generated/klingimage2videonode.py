...
class KlingImage2VideoNode(Node[KlingImage2VideoNodeInputs, KlingImage2VideoNodeOutputs]):
    ...
    def __init__(self, start_frame: Slot[Image] = None, prompt: str = None, negative_prompt: str = None, model_name: Slot[Any] = 'kling-v2-master', cfg_scale: float = 0.8, mode: Slot[Any] = 'std', aspect_ratio: Slot[Any] = '16:9', duration: Slot[Any] = '5'):
