...
class ModelSamplingSD3Advanced_(Node[ModelSamplingSD3Advanced_Inputs, ModelSamplingSD3Advanced_Outputs]):
    ...
    def __init__(self, model: Slot[Model], shift: float = 3.0, cut_off: float = 0.5, shift_multiplier: float = 2):
