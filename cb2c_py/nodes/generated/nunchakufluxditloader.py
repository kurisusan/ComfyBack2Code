...
class NunchakuFluxDiTLoaderInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.cache_threshold = Slot[float](node, "cache_threshold", 'FLOAT')
...
class NunchakuFluxDiTLoader(Node[NunchakuFluxDiTLoaderInputs, NunchakuFluxDiTLoaderOutputs]):
    ...
    def __init__(self, model_path: str, cache_threshold: float = 0, attention: str = 'nunchaku-fp16', cpu_offload: str = 'auto', device_id: int = 0, data_type: str = 'bfloat16'):
