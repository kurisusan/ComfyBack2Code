...
class SamplerER_SDEInputs(InputSlots):
    solver_type: Slot[Any]
    max_stage: Slot[int]
    eta: Slot[float]
    s_noise: Slot[float]
    def __init__(self, node: "Node"):
        self.solver_type = Slot[Any](node, "solver_type", 'COMBO')
...
class SamplerER_SDE(Node[SamplerER_SDEInputs, SamplerER_SDEOutputs]):
    ...
    def __init__(self, solver_type: Slot[Any], max_stage: int = 3, eta: float = 1.0, s_noise: float = 1.0):
