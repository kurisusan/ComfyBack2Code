...
class VHS_LoadVideoPath(Node[VHS_LoadVideoPathInputs, VHS_LoadVideoPathOutputs]):
    ...
    def __init__(self, video: str, force_rate: float = 0, custom_width: int = 0, custom_height: int = 0, frame_load_cap: int = 0, skip_first_frames: int = 0, select_every_nth: int = 1):
